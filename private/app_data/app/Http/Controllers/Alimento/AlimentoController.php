...
class AlimentoController extends Controller
{
    ...
    /**
     * Salva as informa��es b�sicas de um alimento e redireciona para a cria��o de medidas caseiras
    ...
    public function store(Request $request)
    {
        ...
        //Caso o alimento possua medidas caseiras, redireciona para a pagina de informações das mesmas
